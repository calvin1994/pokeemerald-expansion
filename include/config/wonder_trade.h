...
#define WT_NUM_CUSTOM_SPECIES           196   // Number of custom pokemon for array in src/data/wonder_trade_custom_mons.h for WT_TYPE_CUSTOM, default is Yancy + Curtis unique mons.

#define WT_TYPE                         WT_TYPE_CUSTOM // The actual type of wonder trade you are doing.
...
#define WT_RANDOM_MOVESETS              TRUE // Toggles whether a pokemon should have a random in-learnset moveset, or default level up moveset.

#define WT_RANDOM_MOVESET_LEVELUP       4 // How many moves should be levelup moves. Should sum up to 4 with the other move types.
#define WT_RANDOM_MOVESET_TM            0 // How many moves should be TM moves. Should sum up to 4 with the other move types.
#define WT_RANDOM_MOVESET_EGG           0 // How many moves should be egg moves. Should sum up to 4 with the other move types.
#define WT_RANDOM_MOVESET_TUTOR         0 // How many moves should be tutor moves. Should sum up to 4 with the other move types.
...
#define WT_NUM_PERFECT_IVS              0     // Number of perfect IVs a traded pokemon should have. Rest will be random.
...
#define WT_FORMS                        FALSE  // Toggles whether the received pokemon should have a random form on arrival, or default to base (i.e. Paldean, Cosplay, etc).
