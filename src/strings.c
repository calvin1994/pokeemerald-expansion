...
const u8 gText_ExpShare[] = _("EXP MODE");
...
const u8 gText_ExpShareShare[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SOLO"); // When follower flag is CLEAR (0)
const u8 gText_ExpShareSolo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SHARE"); // When follower flag is SET (1)
