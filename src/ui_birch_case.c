...
{
	[BALL_TOP_FIRST]        = {SPECIES_TREECKO, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	[BALL_TOP_SECOND]       = {SPECIES_TORCHIC, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	[BALL_TOP_THIRD]        = {SPECIES_MUDKIP, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	[BALL_TOP_FOURTH]       = {SPECIES_BULBASAUR, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},

	[BALL_MIDDLE_FIRST]     = {SPECIES_CHARMANDER, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	[BALL_MIDDLE_SECOND]    = {SPECIES_SQUIRTLE, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
    [BALL_MIDDLE_THIRD]     = {SPECIES_CHIKORITA, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	
    [BALL_BOTTOM_FIRST]     = {SPECIES_CYNDAQUIL, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
	[BALL_BOTTOM_SECOND]    = {SPECIES_TOTODILE, 5, ITEM_NONE, BALL_POKE, 0xFF, 0xFF, 0xFF},
};
...
static void BirchCase_GiveMon() // Function that calls the GiveMon function pulled from Expansion by Lunos and Ghoulslash
{
    ...
    gSpecialVar_Result = BirchCase_GiveMonParameterized(sStarterChoices[sBirchCaseDataPtr->handPosition].species, sStarterChoices[sBirchCaseDataPtr->handPosition].level, \
                ...
                sStarterChoices[sBirchCaseDataPtr->handPosition].gender, evs, moves, \
